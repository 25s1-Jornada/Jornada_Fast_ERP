...
namespace api_erp.Controllers.OSControllers
{
    ...
    public class ConfirmacoesClienteController : ControllerBase
    {
        private readonly IConfirmacaoClienteRepository _repo;

        public ConfirmacoesClienteController(IConfirmacaoClienteRepository repo)
        {
            _repo = repo;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] ConfirmacaoCliente entity, CancellationToken ct = default)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Update(int id, [FromBody] ConfirmacaoCliente entity, CancellationToken ct = default)
        {
