...
namespace api_erp.Controllers.OSControllers
{
    ...
    public class DescricoesDefeitoController : ControllerBase
    {
        private readonly IDescricaoDefeitoRepository _repo;

        public DescricoesDefeitoController(IDescricaoDefeitoRepository repo)
        {
            _repo = repo;
        }
        ...
        {
            var item = await _repo.GetByOrdemServicoIdAsync(ordemId, includeRelacionamentos, ct);
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] DescricaoDefeito entity, CancellationToken ct = default)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Update(int id, [FromBody] DescricaoDefeito entity, CancellationToken ct = default)
        {
