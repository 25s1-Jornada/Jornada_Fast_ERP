...
namespace api_erp.Controllers.OSControllers
{
    ...
    public class MateriaisController : ControllerBase
    {
        ...
        public MateriaisController(IMaterialRepository repo)
        {
            _repo = repo;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] Material entity, CancellationToken ct = default)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Update(int id, [FromBody] Material entity, CancellationToken ct = default)
        {
