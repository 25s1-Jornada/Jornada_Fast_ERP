...
namespace api_erp.Controllers.OSControllers
{
    ...
    public class DeslocamentosController : ControllerBase
    {
        private readonly IDeslocamentoRepository _repo;

        public DeslocamentosController(IDeslocamentoRepository repo)
        {
            _repo = repo;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] Deslocamento entity, CancellationToken ct = default)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Update(int id, [FromBody] Deslocamento entity, CancellationToken ct = default)
        {
